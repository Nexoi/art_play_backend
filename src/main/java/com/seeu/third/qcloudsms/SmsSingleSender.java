package com.seeu.third.qcloudsms;

import com.alibaba.fastjson.JSONException;
import com.alibaba.fastjson.JSONObject;
import com.seeu.third.qcloudsms.httpclient.HTTPClient;
import com.seeu.third.qcloudsms.httpclient.HTTPException;
import com.seeu.third.qcloudsms.httpclient.HTTPMethod;
import com.seeu.third.qcloudsms.httpclient.HTTPRequest;
import com.seeu.third.qcloudsms.httpclient.HTTPResponse;
import com.seeu.third.qcloudsms.httpclient.DefaultHTTPClient;
...
public class SmsSingleSender extends SmsBase {
    ...
    public SmsSingleSenderResult sendWithParam(String nationCode, String phoneNumber, int templateId,
        ...
        tel.put("mobile", phoneNumber);
        body.put("tel", tel);
        body.put("sig", SmsSenderUtil.calculateSignature(appkey, random, now, phoneNumber));
